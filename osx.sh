...
sudo scutil --set ComputerName "DK MacBook Pro"
sudo scutil --set HostName "DK MacBook Pro"
sudo scutil --set LocalHostName "DK MacBook-Pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "DK MacBook-Pro"
...
#defaults write NSGlobalDomain AppleHighlightColor -string '0.831372 0.9215686 1'
...
# Finder: forbid quitting via ⌘ + Q; doing so will also hide desktop icons
...
defaults write com.apple.terminal "My Profile" -string "Danny"
...
# Disable the debug menu in Address Book
...
# Disbale the debug menu in iCal (pre-10.8)
...
# Disable the WebKit Developer Tools in the Mac App Store
defaults write com.apple.appstore WebKitDeveloperExtras -bool true

# Disable Debug Menu in the Mac App Store
